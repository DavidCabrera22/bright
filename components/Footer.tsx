  ...
  return (
    <footer className="w-full pt-20 pb-10" id="contact">
      ...
      <div className="flex flex-col items-center">
        ...
        Conversemos hoy mismo y descubre cómo Bright People puede impulsar tus proyectos digitales con soluciones a medida.        </p>
        <a href="brightpeople00@gmail.com">
          <MagicButton
